...
var DeleteClientUseCase = /** @class */ (function () {
    function DeleteClientUseCase() {
    }
    DeleteClientUseCase.prototype.execute = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var clientExist, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prismaClient_1.prisma.client["delete"]({
                                where: {
                                    id: id
                                }
                            })];
