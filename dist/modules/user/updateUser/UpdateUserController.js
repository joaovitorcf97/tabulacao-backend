...
var UpdateUserController = /** @class */ (function () {
    ...
    UpdateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, password, updateUserUseCase, newPassword;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = request.params.id;
                        password = request.body.password;
                        updateUserUseCase = new UpdateUserUseCase_1.UpdateUserUseCase();
                        return [4 /*yield*/, updateUserUseCase.execute({
                                idUser: id,
                                newPassword: password
                            })];
                    case 1:
                        newPassword = _a.sent();
                        return [2 /*return*/, response.json(newPassword)];
                }
            });
        });
    };
