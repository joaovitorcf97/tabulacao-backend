...
var CreateClientController = /** @class */ (function () {
    ...
    CreateClientController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, phone, categoryId, id_user, createClientUseCase, newClient;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, phone = _a.phone, categoryId = _a.categoryId;
                    ...
                    case 1:
                        newClient = _b.sent();
                        return [2 /*return*/, response.json(newClient)];
                }
            });
        });
    };
