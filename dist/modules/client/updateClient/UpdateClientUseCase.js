...
var UpdateClientUseCase = /** @class */ (function () {
    function UpdateClientUseCase() {
    }
    UpdateClientUseCase.prototype.execute = function (_a) {
        var name = _a.name, phone = _a.phone, id = _a.id;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prismaClient_1.prisma.client.update({
                                where: {
                                    id: id
                                },
                                data: {
